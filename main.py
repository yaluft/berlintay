...
def main():
    ...
    t.gen_text("Welcome to ... BerlinTay!", 1)
    t.gen_text("Copyright (C) 2023, \x1b[31mX0rzCCleaner\x1b[0m", 2)
    ...
    t.clone_frame(5)
    t.toggle_show_cursor(False)
    t.gen_text("\x1b[93mTAYLOIO (tty1)\x1b[0m", 1, count=5)
    t.gen_text("view?: ", 3, count=5)
    t.toggle_show_cursor(True)
    t.gen_typing_text("yes", 3, contin=True)
    t.gen_text("", 4, count=5)
    t.toggle_show_cursor(False)
    t.gen_text("You sure?:", 4, count=5)
    t.toggle_show_cursor(True)
    t.gen_typing_text("oui!", 4, contin=True)
    t.toggle_show_cursor(False)
    time_now = datetime.now(ZoneInfo("America/Halifax")).strftime(
        "%a %b %d %I:%M:%S %p %Z %Y"
    )
    t.gen_text(f"Local zeit: {time_now} ", 6)
    ...
    --------------
    \x1b[96mOS:     \x1b[93mArch/Debian Linux, Solaris, Windows, Android 14, BSD, Wii-U\x1b[0m
    \x1b[96mHost:   \x1b[93mBerlinTay (aka tayloio) \x1b[94m#NSEC\x1b[0m
    \x1b[96mKernel: \x1b[93mSelf-Taught Computer Guy \x1b[94m#CSE\x1b[0m
    \x1b[96mUptime: \x1b[93m{user_age.years} years, {user_age.months} months, {user_age.days} days\x1b[0m
    \x1b[96mIDE:    \x1b[93mEvery single one(pen and paper scanned files.)\x1b[0m
    
    \x1b[30;101mContact:\x1b[0m
    --------------
    \x1b[96mEmail:      \x1b[93mx0rtay@aidot.org\x1b[0mm
